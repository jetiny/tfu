...
describe('query', function () {
  	it('Query.stringify & Query.parse', function(){
    	var item, val;
    	...
    	item = {"someName": [1, 2, 3], "regularThing": "blah" };
    	expect(val = Query.stringify(item)).to.be( "someName%5B%5D=1&someName%5B%5D=2&someName%5B%5D=3&regularThing=blah");
        expect(Query.parse(val)).to.eql(item);
